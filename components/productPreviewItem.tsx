...
export const ProductPreviewItem: React.FC<ProductPreviewItemProps> = ({ product }) => {
  ...
  return (
    <Link href={`/shop/${product.id}`} className='relative w-[350px] h-[552] bg-[#F4F4F4] rounded-md flex flex-col justify-start items-center cursor-pointer hover:shadow-lg transition-all duration-300 shadow-sm'>
